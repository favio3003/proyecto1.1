...
namespace proyectoTrello.Controllers
{
    public class usuariosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idUsuario,NombreCompleto,Correo,Clave,Telefono,Direccion,Estado,idRol")] usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idUsuario,NombreCompleto,Correo,Clave,Telefono,Direccion,Estado,idRol")] usuario usuario)
        {
            if (ModelState.IsValid)
            {
